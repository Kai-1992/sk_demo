package com.hikvision.portal.points.util;
...
public class EasyExcelUtil {
     ...
     * @param sheetNo       sheet页号，从0开始
     */
    public static <T> void asyncReadModel(String filePath, AnalysisEventListener<T> excelListener, Class<T> clazz, Integer sheetNo) {
     ...
     * @param headRowNum    表头占的行数，从0开始（如果要连表头一起读出来则传0）
     */
    public static <T> void asyncReadModel(InputStream inputStream, AnalysisEventListener<T> excelListener, Class<T> clazz, Integer sheetNo, Integer headRowNum) {
     ...
     * @param data
     */
    public static <T> void writeTemplate(String filePath, String templateFileName, Class<T> headClazz, List data) {
     ...
     * @param data      数据
     */
    public static <T> void write(String filePath, Class<T> headClazz, List data) {
     ...
     * @param sheetName sheet名称
     */
    public static <T> void write(String filePath, Class<T> headClazz, List data, Integer sheetNo, String sheetName) {
     ...
     * @param sheetName    sheet名称
     */
    public static <T> void write(String filePath, Class<T> headClazz, List data, WriteHandler writeHandler, Integer sheetNo, String sheetName) {
     ...
     * @param sheetName   sheet名称
     */
    public static <T> void writeInclude(String filePath, Class<T> headClazz, List data, Set<String> includeCols, Integer sheetNo, String sheetName) {
     ...
     * @param sheetName   sheet名称
     */
    public static <T> void writeExclude(String filePath, Class<T> headClazz, List data, Set<String> excludeCols, Integer sheetNo, String sheetName) {
    ...
    public static class DefaultExcelListener<T> {
    }
}
